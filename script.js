...
function onBtnMenuCloseClick() {
    // console.log(onBtnMenuCloseClick)
...
function onHeroImgClick() {
    if (window.innerWidth >= 1440) {
        if (overlay.childElementCount == 1) {
            ...
            btnOverlayNext.addEventListener('click', BtnClickNext);
            btnOverlayPrevious.addEventListener('click', BtnClickPrevious);
        }
